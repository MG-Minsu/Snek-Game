...
def text_objects (text, font):
    textSurface = button_font.render(text, True, white)
...
def game_intro (): #the initial display you can see
    ...
    while intro:
        ...
        game_display.fill(aquamarine)
        text = title_font.render("SNEK GAME ", True, white)
        game_display.blit(text, [180,200])
        
        mouse = pygame.mouse.get_pos()
        #print (mouse)
        
        button ("START", 100, 255, 100, 35, bright_green, green, "PLAY")
        button ("QUIT", 330, 255, 100, 35, bright_red, red, "BYE")
